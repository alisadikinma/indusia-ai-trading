...
CREATE TABLE IF NOT EXISTS brain.active_sessions (
...
CREATE INDEX IF NOT EXISTS idx_active_sessions_revoked_expires
  ON brain.active_sessions (revoked_at, expires_at);
